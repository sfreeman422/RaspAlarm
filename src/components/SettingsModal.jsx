...
const mapStateToProps = state => ({
  ...
  preciseTemperature: state.userOptions.preciseTemperature
});
...
const mapDispatchToProps = dispatch => ({
  ...
  setPreciseTemperature: showPreciseTemperature =>
    dispatch(actions.setPreciseTemperature(showPreciseTemperature))
});
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <input
              type="checkbox"
              checked={preciseTemperature}
              onChange={() => setPreciseTemperature(!preciseTemperature)}
            />
          </td>
        </tr>
        <tr>
